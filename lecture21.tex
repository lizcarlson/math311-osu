...
\end{theorem}
\begin{proof}
    Since $f$ is continuous on a compact set, it attains a max and a min.  If they both occur at the endpoints, then $f$ is a constant function and consequently $f'(x) = 0$ for all $x \in [a,b]$.  Else, if the max or min occurs on the interior, then it follow from the Interior Extremum Theorem that there exists a $c \in (a,b)$ where $f'(c) = 0.$
\end{proof}

\begin{theorem}{(Mean Value Theorem}
    If $f:[a,b]\to \mathbb{R}$ is continuous on $[a,b]$ and differentiable on $(a,b)$, then there exists a point
\end{theorem}
