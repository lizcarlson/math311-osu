...
\begin{align*}
    ...
    \\
    \phantom{ \mathbb{Z} = \{..., -3, -2, -1, 0, 1, 2, 3 ,...\}} &\quad \text{\textit{but no multiplicative inverse}}
    \\
    \mathbb{Q} = \left\{\frac{p}{q} : p,q \in \mathbb{Z}, \; q\neq 0\right\} &\quad \text{\textit{additive inverse, multiplicative inverse}}
\end{align*}

A set of objects with addition and multiplication defined, with multiplicative and additive inverses, defines a field (see your text for a more formal definition).  While a field is one of the nicest objects possible, there are other operations we might like to be able to understand them and their inverses.  For example, can we always take a number in $\mathbb{Q}$ and find its square root in $\mathbb{Q}$?

\begin{theorem} 
There is no rational number whose square is $2$.
\end{theorem}
\begin{proof}
    We will prove this by \textbf{contradiction} (these types of theorems, stating nothing satisfies a certain claim, are often proved by contradiction).
    ...
    \begin{align}
        ...
        p^2 &= 2q^2.
    \end{align}
    Thus, $p^2$ is a non-zero even number.  Since $p^2$ is even, then $p$ is an even number \textcolor{red}{(WHY)} and we rewrite $p = 2r$.  Therefore,
    \begin{align}
        (2r)^2 &= 2q^2 \\
        2r^2 &= q^2.
    \end{align}
    This implies $q^2$ is even.  Therefore, $q$ is even, and we write it as $q = 2s$.  Thus, $p=2r$ and $q=2s$ are both even, and therefore
    \begin{align}
