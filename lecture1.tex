...
While a field is one of the nicest objects possible, there are other operations we might like to be able to understand them and their inverses.  For example, can we always take a number in $\mathbb{Q}$ and find its square root in $\mathbb{Q}$?
