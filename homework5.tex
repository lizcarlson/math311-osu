...
\begin{exercise}
    Prove one of the following: (bonus if you prove both)
    \begin{enumerate}
        \item Prove that every point in $A\subseteq \mathbb{R}$ is an isolated point if $A = \mathbb{Q}$.
        \item Prove that every point in $A\subseteq \mathbb{R}$ is an isolated point if $A$ is the Cantor set.
    \end{enumerate}
\end{exercise}
